  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
        ...
        <div>
          <p className="mb-3 text-sm tracking-[0.2em] opacity-50">
            {perfume.category}
          </p>
          <h1 className="mb-4 text-3xl tracking-wide sm:text-4xl">
            {perfume.name}
          </h1>
          <p className="mb-6 text-base opacity-80 sm:text-lg">
            {perfume.description}
          </p>
          <p className="mb-8 text-2xl sm:text-3xl">{perfume.price} JOD</p>
