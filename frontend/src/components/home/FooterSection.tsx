        ...
        <div className="mb-8 grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm opacity-60">
              <li>
                <a href="shop" className="transition-opacity hover:opacity-100">
                  {t("home.allProducts")}
                </a>
              </li>
              {/* <li><a href="#categories" className="transition-opacity hover:opacity-100">{t('home.collections')}</a></li> */}
              {/* <li><a href="#new-arrivals" className="transition-opacity hover:opacity-100">{t('home.newArrivals')}</a></li> */}
              <li>
                <a
                  href="#best-sellers"
